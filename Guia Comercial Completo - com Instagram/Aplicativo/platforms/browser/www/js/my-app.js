            ...
            on: {
                pageInit: function (event, page) {
						...
						app.dialog.preloader('Aguarde');
                                ...
                                url: 'https://genialcursos.com.br/app/guia/carregar-cidades.php',
                                crossDomain: true,
                    ...
                    app.panel.enableSwipe('left');
						 ...
						 var swiper = app.swiper.create('.banner-swiper', {
									...
									var swiper = app.swiper.create('.promocoes-swiper', {
										...
										url: 'https://genialcursos.com.br/app/guia/carregar-home.php',
										crossDomain: true,
                ...
                pageInit: function (event, page) {
					...
					app.dialog.preloader('Carregando');
							$.ajax({
										type: 'POST',
										data: { chave:'ok'},
										url: 'https://genialcursos.com.br/app/guia/carregar-categorias.php',
										crossDomain: true,
                ...
                pageInit: function (event, page) {
						...
						app.dialog.preloader('Carregando');
							$.ajax({
										...
										url: 'https://genialcursos.com.br/app/guia/carregar-listaanunciantes.php',
										crossDomain: true,
            ...
            on: {
                pageInit: function (event, page) {
						...
						$.ajax({
										...
										url: 'https://genialcursos.com.br/app/guia/carregar-anunciante.php',
										crossDomain: true,
            ...
            on: {
                pageInit: function (event, page) {
						...
						$.ajax({
										...
										url: 'https://genialcursos.com.br/app/guia/carregar-promocao.php',
										crossDomain: true,
            ...
            on: {
                pageInit: function (event, page) {
						...
						$.ajax({
										type: 'POST',
										data: {cidade:cidade,chave:'ok'},
										url: 'https://genialcursos.com.br/app/guia/carregar-listapromocao.php',
										crossDomain: true,
                ...
                pageInit: function (event, page) {
						...
						app.dialog.preloader('Carregando');
							$.ajax({
										type: 'POST',
										data: {cidade:cidade, chave:'ok'},
										url: 'https://genialcursos.com.br/app/guia/carregar-destaques.php',
										crossDomain: true,
                ...
                pageInit: function (event, page) {
						...
						$("#buscaSearch").submit(function(e){
							...
							app.dialog.preloader('Pesquisando');
                                ...
                                url: 'https://genialcursos.com.br/app/guia/pesquisa.php',
                                crossDomain: true,

...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Destaques
        <small>Controle de destaques</small>
      </h1>
      <ol class="breadcrumb">
	  ...
	  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">Anunciantes Destaque</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				   if ($xquery == true) {
					...
					//PEGAR A CIDADE
					$idCidade=$puxaanunciante['cidade'];
					...
					?>	
                <tr>
				 <td class="hidden"><?php echo $xdestaque['id'] ?></td>
				 <?php if ($puxaanunciante['imagem_perfil']==""){ ?>
				 <td><img src="dist/img/camera.jpg" width="40" height="40"></td>
				 <?php }else { ?>
				 <td><a href="#" data-toggle="modal" data-target="#modalImagem-<?php echo $xdestaque['id'] ?>"><img src="dist/img/anunciantes/perfil/<?php echo $puxaanunciante['imagem_perfil'] ?>" width="40" height="40"></a></td>
				 <?php } ?>
				 <td><?php echo $anunciante ?></td>
                  <td><?php echo $cidade ?></td>
				   <td><?php echo $xdestaque['data_validade'] ?></td>
                  
                  <td>
				  <div class="btn-group">
                      
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-<?php echo $xdestaque['id'] ?>"><i class="fa fa-trash"></i> Remover Destaque</button>
				...
				<div class="modal fade" id="modalImagem-<?php echo $xdestaque['id'] ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Imagem do anunciante</b></h4>
              </div>
              <div class="modal-body">
                <div class="row">
				<div class="col-md-12">					
					
				<img style="max-width:100%;"  alt="" src="dist/img/anunciantes/perfil/<?php echo $puxaanunciante['imagem_perfil'] ?>">
        ...
        <!-- /.modal -->
				...
				<div class="modal fade" id="modal-<?php echo $xdestaque['id'] ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
                <p>Tem certeza que deseja remover destaque de <b>"<?php echo $puxaanunciante['nome'] ?>"</b>?</p>
              </div>
              <div class="modal-footer">
			    <a href="acoes/deletar-destaque.php?ref=<?php echo $xdestaque['id'] ?>" class="btn btn-danger pull-left">Sim. Deletar!</a>
        ...
        <!-- /.modal -->
          ...
          <!-- /.box -->
             ...
             <form id="imagemForm" method="POST" action="acoes/adiciona-destaque.php">   
			<div class="row">
			...
			<div class="form-group col-md-4">
                <label>Destaque até <sup style="color:red"><b>*</b></sup></label>
			...
			<div class="col-md-4">			
			<button type="submit" style="padding:30px" class="btn btn-block btn-success btn-lg">Tornar Destaque</button>
			</div>
		...
		<div class="modal modal-success fade" id="modal-deleted">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Destaque removido com sucesso. Fique tranquilo, isso não exclui o anunciante, apenas o destaque.</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fechar</button>
		...
		<div class="modal modal-success fade" id="modal-edited">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Destaque editado com sucesso!</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fechar</button>
        ...
        <!-- /.modal -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Houve algum problema. Destaque não foi adicionado. Tente novamente!</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fechar</button>

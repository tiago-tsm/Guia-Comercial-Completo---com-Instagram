...
$xconsulta = "SELECT * FROM `anunciantes` order by id";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Anunciantes
        <small>Controle de anunciantes</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Anunciantes</li>
      </ol>
    </section>
	  ...
	  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">Lista de Anunciantes</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				   if ($xquery == true) {
						if ($xquantos>0){
					while ($xanunciantes = mysqli_fetch_assoc($xquery)){
					
					//PEGAR A CIDADE
					$idCidade=$xanunciantes['cidade'];
					...
					if ($cidadequantos==0){
						$cidade="<i><span style='color:red' class='mdi mdi-alarm-light'></span> Sem cidade </i>";
					}else{
					...
					//PEGAR A CATEGORIA
					$idCategoria=$xanunciantes['categoria'];
					...
					$categoriaquantos=mysqli_num_rows($categoriaquery);

					if ($categoriaquantos==0){
						$categoria="<i><span style='color:red' class='mdi mdi-alarm-light'></span> Sem categoria </i>";
					}else{
					    $puxacategoria = mysqli_fetch_assoc($categoriaquery);
						$categoria=$puxacategoria['icone']. " ".$puxacategoria['nome_categoria'];
					}
					
					?>	
                <tr>
				 <td class="hidden"><?php echo $xanunciantes['id'] ?></td>
				 <?php if ($xanunciantes['imagem_perfil']==""){ ?>
				 <td><img src="dist/img/camera.jpg" width="40" height="40"></td>
				 <?php }else { ?>
				 <td><a href="#" data-toggle="modal" data-target="#modalImagem-<?php echo $xanunciantes['id'] ?>"><img src="dist/img/anunciantes/perfil/<?php echo $xanunciantes['imagem_perfil'] ?>" width="40" height="40"></a></td>
				 <?php } ?>
				 <td><?php echo $xanunciantes['nome'] ?>
                  </td>
                  <td><?php echo $cidade ?></td>
                  <td><?php echo $categoria ?>
                  </td>
				  
				   <td><?php echo $xanunciantes['telefone_ligar'] ?>
                  </td>
                  <td>
				  <div class="btn-group">
                      <a href="editar-anunciante.php?id=<?php echo $xanunciantes['id'] ?>" class="btn btn-info"><i class="fa fa-edit"></i> Editar</a>
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-<?php echo $xanunciantes['id'] ?>"><i class="fa fa-trash"></i> Excluir</button>
				...
				<div class="modal fade" id="modalImagem-<?php echo $xanunciantes['id'] ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Perfil e Capa</b></h4>
              </div>
			 ...
			 <div class="card hovercard">
				...
				<img style="max-width:100%;" width="850" height="250" alt="" src="dist/img/capa.jpg">	
				 <?php }else{ ?>	
				<img style="max-width:100%;" width="850" height="250" alt="" src="dist/img/anunciantes/capas/<?php echo $xanunciantes['capa_perfil'] ?>">
				<?php }?>		
                </div>
                <div class="avatar">
                    <img src="dist/img/anunciantes/perfil/<?php echo $xanunciantes['imagem_perfil'] ?>">
        ...
        <!-- /.modal -->
				...
				<div class="modal fade" id="modal-<?php echo $xanunciantes['id'] ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
                <p>Tem certeza que deseja deletar <b><?php echo $xanunciantes['nome'] ?></b>?</p>
              </div>
              <div class="modal-footer">
			    <a href="acoes/deletar-anunciante.php?ref=<?php echo $xanunciantes['id'] ?>" class="btn btn-danger pull-left">Sim. Deletar!</a>
        ...
        <!-- /.modal -->
          ...
          <!-- /.box -->
             ...
             <form id="imagemForm" method="POST" action="acoes/adiciona-anunciante.php" enctype="multipart/form-data">   
			<div class="row">
			...
			<label for="inputCity">Nome do anunciante <sup style="color:red"><b>*</b></sup></label>
			  <input type="text" class="form-control" name="nomeAnunciante" id="nomeAnunciante" placeholder="Nome do anunciante" required>
			...
			<label for="inputCity">Cidade <sup style="color:red"><b>*</b></sup></label>
			  ...
			  <?php
				   if ($acidadequery == true) {
					...
					?>	
                     <option value="<?php echo $acidades['id'] ?>"><?php echo $acidades['cidade'] ?> - <?php echo $acidades['estado'] ?> </option>
			...
			<label for="inputCity">Categoria <sup style="color:red"><b>*</b></sup></label>
			  <select name="categoria" class="form-control" required>
				   ...
				   if ($zxquery == true) {
					...
					?>	
                     <option value="<?php echo $acatego['id'] ?>"><?php echo $acatego['nome_categoria'] ?> </option>
			...
			<label for="inputCity">Telefone Chamadas <sup style="color:red"><b>*</b></sup></label>
			  <input type="text" class="form-control" name="telefoneChamadas" id="telefoneChamadas" placeholder="(00) 00000-0000" required>
		
			</div>
			
			<div class="form-group col-md-4">
			<label for="inputCity">Telefone Whatsapp <sup style="color:red"><b>*</b></sup></label>
			  <input type="text" class="form-control" name="telefoneWhats" id="telefoneWhats" placeholder="(00) 00000-0000" required>
		
			</div>
			
			<div class="form-group col-md-4">
			<label for="inputCity">Link do Facebook</label>
			  <input type="text" class="form-control" name="linkFacebook" id="linkFacebook" placeholder="Link Facebook">
		
			</div>
			
			<div class="form-group col-md-4">
			<label for="inputCity">Link do Instagram</label>
			  <input type="text" class="form-control" name="linkInstagram" id="linkInstagram" placeholder="Link Instagram">
		
			</div>
			
			<div class="form-group col-md-4">
			<label for="inputCity">Endereço Completo <sup style="color:red"><b>*</b></sup></label>
			  <input type="text" class="form-control" name="enderecoCompleto" id="enderecoCompleto" placeholder="Endereço Completo" required>
		
			</div>
			
			<div class="form-group col-md-4">
			<label for="inputCity">Link do Mapa</label>
			  <input type="text" class="form-control" name="linkMapa" id="linkMapa" placeholder="Link Google Maps">
		
			</div>
			
			<div class="form-group col-md-12">
			<label for="inputCity">Descrição da Empresa <sup style="color:red"><b>*</b></sup></label>
			<textarea rows="5" name="descricaoEmpresa" id="descricaoEmpresa" class="textarea" placeholder="Descrição Empresa..."
			...
			<div class="form-group col-md-4">			
			<button type="submit" class="btn btn-block btn-success btn-lg">Adicionar Anunciante</button>
			</div>
		...
		<div class="modal modal-success fade" id="modal-edited">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Anunciante editado com sucesso!</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fechar</button>
